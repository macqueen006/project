<?php use Core\View; ?>
<?php View::setSiteTitle('Bad Token'); ?>
<?php View::start('body'); ?>
            ...
            <div class=akea-not-found-wrap id=akea-full-no-header-wrap>
                ...
                <div class="akea-not-found-container akea-container">
                    ...
                    <div class="akea-not-found-content akea-item-pdlr">
                        ...
                        <h3 class="akea-not-found-title akea-content-font">Your token is corrupted</h3>
                        <div class=akea-not-found-caption>Sorry, BadToken</div>
                        <form role=search method=get class=search-form action=#>
                        <input type=text class="search-field akea-title-font" placeholder="Type Keywords..." value name=s>
                        <div class=akea-top-search-submit><i class="fa fa-search"></i></div>
                        <input type=submit class=search-submit value=Search>
                        </form>
                        <div class=akea-not-found-back-to-home><a href="<?=PROOT;?>home">Or Back To Homepage</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="akea-footer-container akea-container clearfix">
                        ...
                        <div id=text-2 class="widget widget_text akea-widget">
                            ...
                            <div class=textwidget>
                                <p>23 King Street, 5th Avenue, New York
                                    <br> <span class=gdlr-core-space-shortcode id="span_0bb9_0"></span>
                                    <br> +1-2355-3345-5
                                    <br> <span class=gdlr-core-space-shortcode id="span_0bb9_1"></span>
                                    <br> <a id="a_0bb9_0" href=mailto:call@akeablog.co>call@akeablog.co</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="akea-footer-column akea-item-pdlr akea-column-20">
                    ...
                    <div class="akea-footer-column akea-item-pdlr akea-column-20">
                        <div id=text-3 class="widget widget_text akea-widget">
                            ...
                            <div class=textwidget>
                                <div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-none-align" id="div_0bb9_0">
                                    <a href=# target=_blank class=gdlr-core-social-network-icon title=facebook id="a_0bb9_1" rel="noopener noreferrer">
                                        <i class="fa fa-facebook" ></i>
                                    </a>
                                    <a href=# target=_blank class=gdlr-core-social-network-icon title=pinterest id="a_0bb9_2" rel="noopener noreferrer">
                                        <i class="fa fa-pinterest-p" ></i>
                                    </a>
                                    <a href=# target=_blank class=gdlr-core-social-network-icon title=skype id="a_0bb9_3" rel="noopener noreferrer">
                                        <i class="fa fa-skype" ></i>
                                    </a>
                                    <a href=# target=_blank class=gdlr-core-social-network-icon title=twitter id="a_0bb9_4" rel="noopener noreferrer">
                                        <i class="fa fa-twitter" ></i>
                                    </a>
                                    <a href=# target=_blank class=gdlr-core-social-network-icon title=instagram id="a_0bb9_5" rel="noopener noreferrer">
