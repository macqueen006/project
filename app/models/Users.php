...
use Validators\MatchesValidator;
...
class Users extends Model {
  ...
  public function __construct($user='') {
    ...
    if($user != '') {
      if(is_int($user)) {
        $u = $this->_db->findFirst('users',['conditions'=>'id = ?', 'bind'=>[$user]],'Models\Users');
      } else {
        $u = $this->_db->findFirst('users', ['conditions'=>'username = ?','bind'=>[$user]],'Models\Users');
      }
      if($u) {
